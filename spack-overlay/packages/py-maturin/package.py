...
class PyMaturin(PythonPackage):
    ...
    with default_args(type="build"):
        # Require setuptools@61: to ensure setuptools.command.build exists
        depends_on("py-setuptools@61:69")
        depends_on("py-wheel@0.36.2:")
        depends_on("py-setuptools-rust@1.4:")

    def setup_build_environment(self, env):
        # Maturin uses Rust and needs build isolation - do NOT set PIP_NO_BUILD_ISOLATION
        pass
