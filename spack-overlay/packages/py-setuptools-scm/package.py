# docker run -it -v $PWD:$PWD -w $PWD --user root --entrypoint bash d3vnull0/sp5505:                                         latest -cl '. /opt/spack/share/spack/setup-env.sh; spack env activate /opt/spack_env; cat /opt/spack/var/spack/repos/builtin/packages/py-setuptools-scm/package.py > package_setuptools_scm.py'
