...
class TestObservation(unittest.TestCase):
    ...
    def testConstructorWithString(self):
        ...
        self.assertTrue(o.start_date_and_time == datetime.fromisoformat(sDateTime),
            "Observation constructor with string input broken")

        ol: ObservationLong = ObservationLong(start_date_and_time=sDateTime, number_of_days = 2)
        self.assertTrue(ol.start_date_and_time == datetime.fromisoformat(sDateTime),
    ...
    def testConstructorWithDateTime(self):
        ...
        self.assertTrue(o.start_date_and_time == dt,
        ...
        self.assertTrue(ol.start_date_and_time == dt,
