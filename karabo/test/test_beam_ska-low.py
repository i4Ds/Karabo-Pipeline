...
class MyTestCase(unittest.TestCase):
    ...
    def test_beam(self):
        ...
        dirty.write_to_file("./karabo/test/result/beam/ska_low_array_vis.fits",overwrite=True)
        #dirty.plot(title='Flux Density (Jy)')
        #os.system('mv ./karabo/test/result/beam/ska_low_array_vis.fits ./karabo/test/result/beam/ska_low_no_array_vis.fits')
        ...
        ax.imshow(diff,aspect='auto',origin='lower',vmin=-1.e-1,vmax=1.e-1)
        plt.show()
