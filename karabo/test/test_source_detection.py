...
from karabo.Imaging import source_detection, imager
...
class TestSourceDetection(unittest.TestCase):
    ...
    def test_read_both_files_and_plot(self):
        before = open_fits_image("./restored_before.fits")
        before.plot()
        after = open_fits_image("./restored_after.fits")
        after.plot()