...
class TestSystemNoise(unittest.TestCase):
    ...
    def disabled_spectral_line(self):
        ...
        if make_foreground_image:
            ...
            dirty.write_to_file(
                "./result/spectral_line/foreground.fits", overwrite=True
            )
        ...
        spectral_vis_output, spectral_ms_output = self.simulate_spectral_vis(
            ra_spec,
            dec_spec,
            phase_ra,
            phase_dec,
        ...
        combined_vis_filepath = (
            "./result/spectral_line/combined_fg_spectral_line_vis.ms"
        )
        spec_path = "./result/spectral_line/"
        spectral_vis_output = [0] * npoints
        for i in range(npoints):
